...
<head>
  ...
  <title>Tentang Kami - Buahhatiku</title>
  <!-- Bootstrap CSS -->
  ...
  <section class="contact_us_area section_gap">
    <div class="container">
      ...
      <div class="row mt-4">
        <div class="col-lg-12 text-center">
          <p>Follow us on:</p>
          <a href="#" class="mr-3"><i class="fa fa-facebook fa-2x"></i></a>
          <a href="#" class="mr-3"><i class="fa fa-instagram fa-2x"></i></a>
          <a href="#" class="mr-3"><i class="fa fa-youtube fa-2x"></i></a>
